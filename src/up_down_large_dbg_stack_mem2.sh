...
export THREAD_STACK_SIZE=262144
...
NPROC="-n 16384"
LPG="lpgparm -s 32MB -d 32MB -t 256MB -p 4MB"
PROF=""
EXEC_FILE="./estimate_main"
echo "${PROF} ${MPIEXEC} ${LPG} ${NPROC} ${EXEC_FILE}"
time  ${PROF} ${MPIEXEC} ${LPG} ${NPROC} ${EXEC_FILE}
